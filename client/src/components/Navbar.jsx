                    ...
                    >
                        <div className="p-6 flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-4">
                                <span className="text-xs font-bold uppercase tracking-widest text-gray-500">All Genres</span>
                                <div className="grid grid-cols-2 gap-2">
                                    {genres.slice(0, 10).map((genre) => (
                                        <button
                                            key={genre.id}
                                            onClick={() => handleGenreSelect(genre)}
                                            className="text-left px-4 py-3 bg-white/5 rounded-xl text-sm font-medium text-gray-300"
                                        >
                                            {genre.name}
                                        </button>
                                    ))}
